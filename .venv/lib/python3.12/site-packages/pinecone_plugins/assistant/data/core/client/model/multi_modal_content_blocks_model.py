...
def lazy_import():
    ...
    globals()['MultiModalContentImageBlockModel'] = MultiModalContentImageBlockModel
    globals()['MultiModalContentTextBlockModel'] = MultiModalContentTextBlockModel


class MultiModalContentBlocksModel(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'MultiModalContentImageBlockModel': MultiModalContentImageBlockModel,
            'MultiModalContentTextBlockModel': MultiModalContentTextBlockModel,
            'image': MultiModalContentImageBlockModel,
            'text': MultiModalContentTextBlockModel,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MultiModalContentBlocksModel - a model defined in OpenAPI

        Keyword Args:
            type (str): The type of multimodal content block.
            ...
            image (ImageModel): [optional]  # noqa: E501
