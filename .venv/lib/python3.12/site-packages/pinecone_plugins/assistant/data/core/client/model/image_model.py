...
class ImageModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, mime_type, data, *args, **kwargs):  # noqa: E501
        """ImageModel - a model defined in OpenAPI

        Args:
            type (str): The format of the image data. Currently, this is always \"base64\".
            mime_type (str): The MIME type of the image (e.g., \"image/jpeg\").
            data (str): The image data. Currently, this is always a base64-encoded string.
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, mime_type, data, *args, **kwargs):  # noqa: E501
        """ImageModel - a model defined in OpenAPI
