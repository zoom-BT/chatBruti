...
class MarkdownReferenceModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, file, *args, **kwargs):  # noqa: E501
        """MarkdownReferenceModel - a model defined in OpenAPI

        Args:
            type (str): The type of reference. Always \"markdown\".
