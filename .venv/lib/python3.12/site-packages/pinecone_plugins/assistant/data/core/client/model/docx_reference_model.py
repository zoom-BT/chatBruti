...
class DocxReferenceModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, file, pages, *args, **kwargs):  # noqa: E501
        """DocxReferenceModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, file, pages, *args, **kwargs):  # noqa: E501
        """DocxReferenceModel - a model defined in OpenAPI
